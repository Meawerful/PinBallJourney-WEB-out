...
/** @type {string} */
const CACHE_VERSION = '1790327473|4342318';
/** @type {string} */
const CACHE_PREFIX = 'PinBallJourney-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'PinballJourneyV0.63.offline.html';
/** @type {boolean} */
...
/** @type {string[]} */
const CACHEABLE_FILES = ["PinballJourneyV0.63.wasm","PinballJourneyV0.63.pck?v=13bc6d804b28"];
